...
function Footer() {
    return (
        <footer>
                ...
                <div className="row">
                    ...
                    <div className="footer-col">
                        <ul>
                            ...
                            <li><a href="#">0812-3456-78</a></li>
                            <li><a href="#">ciura@gmail.com</a></li>
                        </ul>
                    </div>
                    <div className="footer-col">
                        <h4>Media Sosial Kami</h4>
                        <ul className="medsos">
                            <li><a href="#"><FaFacebook className="fa-brands" /></a></li>
                            <li><a href="#"><FaInstagram className="fa-brands" /></a></li>
                            <li><a href="#"><FaWhatsapp className="fa-brands" /></a></li>
                        </ul>
                    </div>
            ...
            <div style={{ marginTop: "70px", textAlign: "center", color: "#ffffff", fontWeight: "bold" }} className="copyright">Copyright 2023 © Ciura. All rights reserved</div>
        </footer >
    )
}
